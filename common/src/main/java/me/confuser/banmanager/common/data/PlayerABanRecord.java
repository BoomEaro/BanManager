...
public class PlayerABanRecord {
  ...
  public PlayerABanRecord(PlayerABanData ban, PlayerData actor, String reason) {
  ...
  public PlayerABanRecord(PlayerABanData ban, PlayerData actor, long created) {
    player = ban.getPlayer();
